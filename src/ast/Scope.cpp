...
// atl::shared_ptr<FunDecl> Scope::findOpOverload(const atl::string
// &objSignature,
//                                                const atl::string &op) const {
//   const atl::shared_ptr<FunDecl> localFind =
//       findOpOverloadLocal(objSignature, op);
//   if (localFind != nullptr)
//     return localFind;
//   else if (outerScope != nullptr)
//     return outerScope->findOpOverload(objSignature, op);
//   else
//     return nullptr;
// }

// atl::shared_ptr<FunDecl>
// Scope::findOpOverloadLocal(const atl::string &objSignature,
//                            const atl::string &op) const {
//   for (int idx = decls.size() - 1; idx >= 0; --idx) {
//     if (decls[idx]->astClass() != "FunDecl" &&
//         decls[idx]->astClass() != "FunDef")
...
//         atl::static_pointer_cast<FunDecl>(decls[idx]);
//     const atl::string currFunDeclSig = currFunDecl->getSignature();
//     if (currFunDecl->getSignature() == objSignature) {
//       return currFunDecl;
//     }
//   }
