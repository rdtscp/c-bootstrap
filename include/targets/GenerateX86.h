...
private:
  ...
  atl::shared_ptr<X86::Operand> visit(DestructorDecl &dd) override;
  ...
  atl::shared_ptr<X86::Operand> visit(Nullptr &n) override;
  ...
  atl::shared_ptr<X86::Operand> visit(TemplateDef &td) override;
